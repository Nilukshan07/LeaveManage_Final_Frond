...
const server = http.createServer(async (req, res) => {
  ...
  } else if (req.url === "/login") {  // Handle the login page route
    filePath = "./static/css/login.html"; // Update the path to the correct directory
    layout_use = "./layouts/Topnavigation.html"; // You can choose a different layout if needed

    
  } else if (req.url === "/Manager/leaveRequest") {
    filePath = "./views/leaves/managerLeaveManagement.html";  // Path to your managerLeaveManagement.html file
    layout_use = "./layouts/Topnavigation.html";  // You can use the same or another layout

  } else if (req.url === "/Employee/leaveRequest") {
    filePath = "./views/leaves/leaveRequest.html";  // Path to your managerLeaveManagement.html file
    layout_use = "./layouts/Topnavigation.html";  // You can use the same or another layout
